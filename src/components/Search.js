...
const Search = () => {
  ...
  return (
    ...
    rounded-lg'> 
        ...
        <PropertyDropdown/>
        <PriceRangeDropdown/>
        <button onClick={() => handleClick()} className='bg-violet-700 hover:bg-violet-800 transition w-full lg:max-w-[130px] h-10 rounded-lg flex justify-center items-center text-white text-lg'>
          <RiSearch2Line/>
